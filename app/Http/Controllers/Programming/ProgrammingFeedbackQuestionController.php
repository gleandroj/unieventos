...
use UniEventos\Http\Resources\ProgrammingFeedbackQuestionResource;
...
class ProgrammingFeedbackQuestionController extends Controller
{
    /**
    ...
    {
        return ProgrammingFeedbackQuestionResource::collection(
            ProgrammingFeedbackQuestion::paginate(
                request('per_page', 10),
                request('order_by', 'id'),
